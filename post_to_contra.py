...
#     usps = config.BRAND_USPS if hasattr(config, "BRAND_USPS") else "AI-native implementation partner for remote developer teams"
...
#         if not content:
#             content = f"Working on Gaper ({config.PRIMARY_URL}) — an AI-native implementation partner helping teams deploy supervised AI workflows with vetted remote developers within 24 hours. Focused on production-ready automation."
#         print("✅ Content generated!")
#         return content
#     except Exception as e:
#         logger.error(f"Gemini generation failed: {e}")
#         return f"Working on Gaper ({config.PRIMARY_URL}) — helping teams build supervised AI workflows with vetted remote developers within 24 hours."
...
#         return {"status": "failed", "detail": "No saved Contra session. Run 'python setup_contra_login.py' first."}
...
#                 'textarea[placeholder*="updates" i]',
#                 'textarea[placeholder*="highlights" i]',
...
#                         post_box = el
#                         print(f"✅ Found post box with: {selector}")
#                         break
#                 except Exception as e:
#                     print(f"⚠️ Selector {selector} failed: {e}")

#             if not post_box:
#                 print("❌ Post box not found. Keeping browser open for manual inspection...")
